...
# Tweak these after checking the popup against your pixel-art templates.
...
func _setup_dynamic_buttons(npc: NPCData) -> void:
	choice_c.text = "Request More Documents"
